	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
				...
				<span class="col-md-6">
					<div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">VAT Posting Group:</label>
					   <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="30" tabindex="1" name="VBPG_Code" placeholder="VAT Posting Group">
				      </div>
          </div>					
				  <div class="form-group">
			...
			<div class="btn-cont">
				...
				<a type="button" tabindex="5" href="<?= base_url() ?>app/financial-management/vat-setup" class="btn btn-default form-btn sub-clr">
				   Cancel
				</a>
			</div>
		</div>
