			...
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="30" value="<?=$data['VPPG_Code']?>" tabindex="1" name="VPPG_Code" placeholder="VAT Product Posting Group">
				    </div>
					</div>
				  <div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Description:</label>
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="100" value="<?=$data['VPPG_Description']?>" tabindex="2" name="VPPG_Description" placeholder="Description">
				    </div>
					</div>
				</span>
			</form>
