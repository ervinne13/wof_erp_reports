	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
				    ...
				    <div class="form-group">
				      	...
				      	<div class="col-xs-7">
					      	<select class="form-control single-default select-cli" placeholder="WHT Bus. Posting Group" id="" maxlength="30" name="WPS_WBPG_FK_Code" tabindex="1">
							  	  ...
							  	  ?>
							  		<option value="<?=$value['WBPG_Code']?>" ><?=$value['WBPG_Code']?></option>
							  	  <?php }} ?>
							    </select>
						    </div>
				    </div>
            <div class="form-group">
                ...
                <div class="col-xs-7">
                  <select class="form-control single-default select-cli" placeholder="WHT Prod. Posting Group" id="" maxlength="30" name="WPS_WPPG_FK_Code" tabindex="2">
                    ...
                    ?>
                    <option value="<?=$value['WPPG_Code']?>" ><?=$value['WPPG_Code']?></option>
                    <?php }} ?>
                  </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-7">
                    <input type="text" class="form-control dc-mal" id="" maxlength="20" tabindex="3" name="WPS_WHT" placeholder="WHT%">
                </div>
              </div> 
            <div class="form-group">
                <label class="control-label col-xs-5" for="">Payable Account:</label>
                <div class="col-xs-7">
                    <select class="form-control single-default select-cli" placeholder="Payable Account" id="" maxlength="30" name="WPS_COA_FK_PayableAccountNo" tabindex="4">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-7">
                    <input type="text" class="form-control" id="" maxlength="20" tabindex="5" name="WPS_TaxCode" placeholder="Withholding Tax Code (WHT)">
                </div>
            </div>   
				</span>
			</form>
