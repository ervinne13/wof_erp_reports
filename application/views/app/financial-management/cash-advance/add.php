            ...
            <form id="<?= $this->uri->segment(3) ?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
                <span class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" readonly class="form-control" tabindex="1" name="CA_DocNo" placeholder="Document No.">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" tabindex="4" name="CA_Remarks" placeholder="Remarks">
                        </div>
                    </div>
                </span>
                <span class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control datepicker" tabindex="6" name="CA_DateFrom" placeholder="From">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5"></label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control datepicker" tabindex="7" name="CA_DateTo" placeholder="To">
                        </div>
                    </div>
                    <!--/Date Needed-->
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" readonly class="form-control" tabindex="8" name="CA_Amount" placeholder="Amount">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5">CA Request Status:</label>
                        <div class="col-xs-7">
                            <input type="text" readonly class="form-control" tabindex="9" name="CA_RequestStatus" placeholder="CA Request Status">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">CA Liquidation Status:</label>
                        <div class="col-xs-7">
                            <input type="text" readonly class="form-control" tabindex="10" name="CA_LiquidationStatus" placeholder="Liquidation Request Status">
                        </div> 
                    </div>
                </span>
                <span class="col-md-4">
                            ...
                            <select class="form-control single-default" placeholder="Company" id="" name="CA_Company" tabindex="14">
                                ...
                                if (!empty($Com)) {
                                    foreach ($Com['data'] as $key => $value) {
                                        ?>
                                        <option value="<?=$value['COM_Id']?>" <?=$company==$value['COM_Id']?'selected':''?> > <?= $value['COM_Name'] ?></option>
                                        <?php
                                    }
                                }
                                ?>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" name="CA_Company"  tabindex="11" class="form-control" placeholder="Company" value="<?= $company ?>">
                        </div>
                    </div> -->
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    (function () {
        ...
        $(document).ready(function () {
            ...
            moduleProcessor.loadNumberSeries('input[name=CA_DocNo]');
