...
<?php
$back_url = base_url("app/" . $this->uri->segment(2) . "/" . $this->uri->segment(3) . "/view?id=" . md5($CRJD_PFK_DocNo));
?>
            ...
            <form id="cash-receipt-journal-detail-form" class="form-horizontal row page-form" role="form" class="container-fluid">
                ...
                <span class="col-md-5">                    
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly id="" tabindex="2" name="CRJD_AppliesToDocType" placeholder="Applies-to Doc Type." value="<?= $CRJD_AppliesToDocType ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sel1" class="control-label col-xs-5">Applies-to Doc No.:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly id="" tabindex="3" name="CRJD_AppliesToDocNo" placeholder="Applies-to Doc No." value="<?= $CRJD_AppliesToDocNo ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sel1" class="control-label col-xs-5">Applies-to Doc Date:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly id="" tabindex="4" name="CRJD_AppliesToDocDate" placeholder="Applies-to Doc Date" value="<?= $CRJD_AppliesToDocDate ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sel1" class="control-label col-xs-5"> Applies-to Amount (Balance):</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly id="" tabindex="5" name="CRJD_AppliesToAmount" placeholder=" Applies-to Amount (Balance)" value="<?= $CRJD_AppliesToAmount ?>">
                        </div>
                    </div>
                </span><!--/Left Panel-->
                <!--Right Panel-->
                <span class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" value="<?= $CRJD_AppliedAmount ?>"  tabindex="6" name="CRJD_AppliedAmount" placeholder=" Applied Amount">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Rem. Amount:</label>
                        <div class="col-xs-7">
                            <input type="text" readonly class="form-control" value="<?= $CRJD_RemAmount ?>" tabindex="7" name="CRJD_RemAmount" placeholder=" Rem. Amount">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Comment:</label>
                        <div class="col-xs-7">
                            <textarea type="text" class="form-control" id="" tabindex="8" name="CRJD_Comment" placeholder="Comment"><?= $CRJD_Comment ?></textarea>
                        </div>
                    </div>
                </span><!--/Right Panel-->
            </form>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function save(onSaveCallback) {
            ...
            formData.append('id', '<?= $this->input->get('id'); ?>');
