...
<?php
$document_header_id = md5($GJD_PFK_DocNo);
            ...
            <form id="<?= $this->uri->segment(3) ?>-form" class="form-horizontal row page-form" role="form" class="container">
                <span class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control datepicker" tabindex="1" name="GJD_PostingDate" placeholder="Posting Date" value="<?= $GJD_PostingDate ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">                            
                            <select class="form-control single-default" placeholder="Account Type" id="" name="GJD_AccountType" tabindex="2">
                                ...
                                <option value="Bank Account" <?= $GJD_AccountType == "Bank Account" ? "selected" : "" ?>>Bank Account</option>
                                <option value="Customer" <?= $GJD_AccountType == "Customer" ? "selected" : "" ?>>Customer</option>                                
                                <option value="G/L Account" <?= $GJD_AccountType == "G/L Account" ? "selected" : "" ?>>G/L Account</option>
                                <option value="Supplier" <?= $GJD_AccountType == "Supplier" ? "selected" : "" ?>>Supplier</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <select class="form-control single-default" placeholder="Account Name." id="" name="GJD_AccountName" tabindex="3">
                                ...
                                <?php foreach ($account_numbers AS $account): ?> 
                                    <?php $selected = ($GJD_AccountName == $account["AccountName"]) ? "selected" : "" ?>
                                    <option value="<?= $account["AccountName"] ?>" <?= $selected ?>>
                                        <?= $account["AccountName"] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">                        
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="4" name="GJD_AccountNo" placeholder="Account No." value="<?= $GJD_AccountNo ?>">
                        </div>
                    </div>                    
                </span>
                <span class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" tabindex="5" name="GJD_Debit" placeholder="Debit" value="<?= $GJD_Debit ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Credit:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" tabindex="6" name="GJD_Credit" placeholder="Credit" value="<?= $GJD_Credit ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Amount:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" tabindex="7" name="GJD_Amount" placeholder="Amount" value="<?= $GJD_Amount ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">CY:</label>
                        <div class="col-xs-7">
                            <select class="form-control select-cli" name="GJD_CY" placeholder="CY"> 
                                <option value="" disabled selected></option>
                                <?php foreach ($currencies["data"] AS $currency): ?>
                                    <?php $selected = ($GJD_CY == $currency["AD_Code"]) ? "selected" : "" ?>
                                    <option value="<?= $currency["AD_Code"] ?>" <?= $selected ?>>
                                        <?= $currency["AD_Desc"] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="8" name="GJD_AmountLCY" placeholder="Amount LCY" value="<?= $GJD_AmountLCY ?>">
                        </div>
                    </div>
                </span>
                <span class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <select class="form-control select-cli" name="GJD_CPC" placeholder="CPC"> 
                                <option value="" disabled selected></option>
                                <?php if (count($locations) > 1): ?>
                                    <option value="" disabled selected>Location</option>
                                    <?php foreach ($locations AS $location): ?>
                                        <?php $selected = ($GJD_CPC == $location["SP_StoreID"]) ? "selected" : "" ?>
                                        <option value="<?= $location["SP_StoreID"] ?>" <?= $selected ?>>
                                            <?= $location["SP_StoreName"] ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <input type="text" class="form-control" id="" readonly value="<?= $locations[0]['SP_StoreID'] ?>" tabindex="9" name="GJD_CPC" placeholder="Location">
                                <?php endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <textarea class="form-control" name="GJD_Comment" placeholder="Comment"><?= $GJD_Comment ?></textarea>
                        </div>
                    </div>
                </span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var currentlyAvailableAccounts = <?= json_encode($account_numbers) ?>;
        var $accountType;
        var $accountName;
        ...
        function loadAccounts(accountType) {
            ...
            var url = "<?= $module_url ?>/get_account_numbers/" + encodeURIComponent(accountType);
