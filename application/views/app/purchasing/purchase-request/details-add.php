			...
			<form class="form-horizontal row page-form" role="form" class="container">
				<span class="col-md-4">
					...
					<div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="date" class="form-control" id="" tabindex="2" name="u_username" placeholder="Remaining Qty">
				      </div>
				    </div>
				</span>
				<span class="col-md-4">
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="UOM">
				      </div>
				    </div>
				    <div class="form-group">
				      <label for="sel1" class="control-label col-xs-5">Currency:</label>
				      <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Currency" tabindex="3" >
				      </div>
				    </div>
				    <div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Unit Price:</label>
					  <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Unit Price" tabindex="3" >
				      </div>
					</div>
					<div class="form-group">
				      <label class="control-label col-xs-5" for="" name="u_password">Amount:</label>
				      <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Amount" tabindex="3" >
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Amount in LCY:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Amount in LCY">
				      </div>
				    </div>
				</span>
				<span class="col-md-4">
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Vendor">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Store:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Store">
				      </div>
				    </div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Reference to">
				      </div>
				    </div>
				</span>
			</form>
