			...
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				...
				<span class="col-md-5">
					<div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="MCO" id="" tabindex="2" name="u_username" placeholder="Transfer From">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Transfer To:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="SOO" id="" tabindex="2" name="u_username" placeholder="Transfer To">
				      </div>
				    </div>
				    <div class="form-group">
