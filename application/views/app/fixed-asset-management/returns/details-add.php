			...
			<form class="form-horizontal row page-form" role="form" class="container">
				...
				<span class="col-md-4">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Comment" tabindex="3" >
				      </div>
				    </div>
				    <div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Cost Center:</label>
					  <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Cost Center" tabindex="3" >
				      </div>
					</div>
				</span>
			</form>
