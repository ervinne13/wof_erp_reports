                ...
                <div class="row">
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_DocNo ?></label>                                
                            </div>
                        </div>                    
                        <div class="form-group">
                            <label class="control-label col-xs-5" for="">Reference No.:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_RefNo ?></label>                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-5" for="">Remarks:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_Remarks ?></label>                                
                            </div>
                        </div>                   
                    </span>
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_DocDate ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-xs-5">Location:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_Location ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-xs-5">Company:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_Company ?></label>
                            </div>
                        </div>
                    </span>
                </div>
                ...
                <div class="row">
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_ItemDescription ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-5" for="">Asset ID:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_AssetID ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-xs-5" for="">Item No:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_ItemNo ?></label>
                            </div>
                        </div>                   
                    </span>
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_NatureOfDefect ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-xs-5">Job Needed:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_JobNeeded ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-xs-5">Technician:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_Technician ?></label>
                            </div>
                        </div>
                    </span>
                </div>
                ...
                <div class="row">
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_DateDown ?></label>
                            </div>
                        </div>                    
                        <div class="form-group">
                            <label class="control-label col-xs-5" for="">Date Operational:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_DateOperational ?></label>
                            </div>
                        </div>
                    </span>
                    <span class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_DowntimeDays ?></label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-xs-5">Status:</label>
                            <div class="col-xs-7">
                                <label class="control-label"><?= $JO_Status ?></label>
                            </div>
                        </div>                        
                    </span>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#tbl-jo-details').bind('dynatable:init', function (e, dynatable) {
