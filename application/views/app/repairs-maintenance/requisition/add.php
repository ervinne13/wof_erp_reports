			...
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				...
				<span class="col-md-5">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Request From">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Request To:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Request To">
				      </div>
				    </div>
				</span>
			</form>
