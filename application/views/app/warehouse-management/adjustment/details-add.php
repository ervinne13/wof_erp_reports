			...
			<form class="form-horizontal row page-form" role="form" class="container">
				...
				<span class="col-md-4">
					<div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="2" name="u_username" placeholder="On Hand Qty">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Adjusted Qty:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control"  id="" tabindex="2" name="u_username" placeholder="Adjusted Qty">
				      </div>
				    </div>
				    <div class="form-group">
