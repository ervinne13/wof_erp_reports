	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
              ...
              <div class="col-xs-7">
                <input type="text" class="form-control" id="" maxlength="30" value="" tabindex="1" name="R_Id" placeholder="Reason ID">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-xs-5" for="">Description:</label>
              <div class="col-xs-7">
                <input type="text" class="form-control" id="" maxlength="100" value="" tabindex="2" name="R_Description" placeholder="Description">
              </div>
            </div>
				    <div class="form-group">
				      	<label class="control-label col-xs-5" for="">Modules:</label>
				      	<div class="col-xs-7">
					      	<select class="form-control single-default select-mul" multiple id="" placeholder='Modules' name="RM_FK_Module_id[]" tabindex="3">
			...
			<div class="btn-cont">
				...
				<a type="button" tabindex="6" href="<?= base_url() ?>app/administration/reason" class="btn btn-default form-btn sub-clr">
				   Cancel
				</a>
			</div>
		</div>
