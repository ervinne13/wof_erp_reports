			...
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="30" value="<?= $data['CT_Id']; ?>" tabindex="1" name="CT_Id" placeholder="Customer Type Id">
				      </div>
					</div>
				    <div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Description:</label>
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="100" value="<?= $data['CT_Description']; ?>" tabindex="2" name="CT_Description" placeholder="Description">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Tin Required:</label>
				      <div class="col-xs-7">
				        <input type="checkbox" <?= $data['CT_TinRequired']==1?'checked':''; ?> name="CT_TinRequired" tabindex="3">
				      </div>
				    </div>
				</span>
			</form>
