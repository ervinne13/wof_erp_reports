<div class="panel">
	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Customer Type Id:</label>
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="30" tabindex="1" name="CT_Id" placeholder="Customer Type Id">
				      </div>
					</div>
				    <div class="form-group">
					  <label for="sel1" class="control-label col-xs-5">Description:</label>
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="100" tabindex="2" name="CT_Description" placeholder="Description">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Tin Required:</label>
				      <div class="col-xs-7">
				        <input type="checkbox"  name="CT_TinRequired" tabindex="3">
				      </div>
				    </div>
				</span>
			</form>
			<hr>
			<div class="btn-cont">
				<a type="button" id="save-new" tabindex="4" href="javascript:void(0)" class="btn btn-default form-btn main-clr">
				  Save & New
				</a>
				<a type="button" id="save-close" tabindex="5"  href="javascript:void(0)" class="btn btn-default form-btn main-clr">
				  Save & Close
				</a>
...
<script type="text/javascript">
  ...
  $nseries = $('input[name=CT_Id]').numseries({
