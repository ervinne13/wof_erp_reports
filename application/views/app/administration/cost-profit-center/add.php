	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="30" tabindex="1" name="CPC_Id" placeholder="Cost Profit ID">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Description:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" maxlength="200" tabindex="2" name="CPC_Desc" placeholder="Description">
				      </div>
				    </div>
				    <div class="form-group">
				      	<label class="control-label col-xs-5" for="">CPCenter Class:</label>
				      	<div class="col-xs-7">
					      	<select class="form-control single-default select-cli" id="" placeholder="CPCenter Class" name="CPC_FK_Class" tabindex="3">
			...
			<div class="btn-cont">
				...
				<a type="button" tabindex="6" href="<?= base_url() ?>app/administration/cost-profit-center" class="btn btn-default form-btn sub-clr">
				   Cancel
				</a>
			</div>
		</div>
