			...
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="B_Id" placeholder="Buyer Class ID">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Description:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="2" name="B_Description" placeholder="Description">
				      </div>
				    </div>
				</span>
				<span class="col-md-6">
				     <div class="form-group">
				      	...
				      	<div class="col-xs-7">
					      	<select class="form-control single-default select-mul" multiple id="" placeholder='Buyers' name="BS_FK_User_id[]" tabindex="6">
							  	<option value="" disabled selected>Buyers</option>
							  	<?php 
							  		if(!empty($user['data'])){
							  			foreach ($user['data'] as $key => $value) {
							  	?>
							  		<option value="<?=$value['U_User_id']?>" ><?=$value['U_Username']?></option>
							  	<?php }} ?>
							</select>
						</div>
				    </div>
