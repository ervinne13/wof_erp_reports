            ...
            <form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" readonly tabindex="1" value="<?=$data['RQL_DocNo']?>" name="RQL_DocNo" placeholder="Document No.">
				      </div>
					</div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Location:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" readonly tabindex="1" value="<?=$data['RQL_Location']?>" name="" placeholder="Purpose">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Request To:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly tabindex="4" value="<?=$data['RQL_RequestTo']?>" name="RQL_RequestTo" value=""  placeholder="Remarks">
				       </div> 
				    </div> 
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Remarks:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly tabindex="4" value="<?=$data['RQL_Remarks']?>" name="RQL_Remarks" value=""  placeholder="Remarks">
				       </div> 
				    </div>
				</span>
				<span class="col-md-6">
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="" tabindex="2" value="<?=format($data['RQL_DocDate'])?>" name="RQL_DocDate" value="<?=date("m/d/Y",time())?>" placeholder="Document Date">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Requestor:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="" tabindex="2" value="<?=$data['RQL_Requestor']?>" name="RQL_Requestor" placeholder="Date Needed">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Status:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="" tabindex="2" value="<?=$data['RQL_Status']?>" name="RQL_Status" placeholder="Date Needed">
				      </div>
				    </div>
				</span>
			</form>
            ...
            remarks   = $('#remarks').val();
                 $.ajax({
                      ...
                      data:{id:JSON.stringify(id),
                            type:type,
                            remarks:remarks},
                        url: base_url+'app/sales-operation/requisition_local/process',
...
var table = $('#tbl-requisition-local-details').bind('dynatable:init', function(e, dynatable) {
        ...
        $('#dynatable-search-'+'tbl-requisition-local-details').append("<a  href='javascript:void(0)' class='clear'>Clear</a>");
        $('#dynatable-per-page-tbl-requisition-local-details').after(select);
        ...
        $('#status-filter').on('change', function() {
          ...
          if (value === "") {
            ...
            $.ajax({
                url: base_url + 'app/sales-operation/requisition_local/get_functions',
                type: 'POST',
                data: {status:value,
                       docNo:docID},
                dataType:'json',
       ...
       $(this).wrap('<div class="table-container"></div>')
        ...
        dataset: {
            ajax: true,
            ajaxUrl: base_url + "app/sales-operation/requisition_local/details-data/?id="+"<?=$this->input->get('id')?>",
            ajaxOnLoad: true,
            records: []
        },
        features: {
