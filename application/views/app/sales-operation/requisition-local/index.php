...
var	table = $('#tbl-requisition-local').bind('dynatable:init', function(e, dynatable) {
    	$('#dynatable-search-tbl-requisition-local').prepend('Date Filter: <input type="search" data-dynatable-query="date-from" name="date-from" id="date-from"/><input type="search" data-dynatable-query="date-to" name="date-to" id="date-to"/> ')
		...
		dataset: {
			ajax: true,
		    ajaxUrl: base_url + "app/sales-operation/requisition-local/data",
		    ajaxOnLoad: true,
		    records: []
		},
		features: {
