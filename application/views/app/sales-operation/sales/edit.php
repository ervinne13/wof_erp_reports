			...
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-5">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" value="CSR-10001" tabindex="1" name="u_userid" placeholder="Document No.">
				      </div>
					</div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" value="[Cashier #]" tabindex="1" name="u_userid" placeholder="Cashier #">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Cashier Name:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" value="[Cashier Name]" tabindex="1" name="u_userid" placeholder="Cashier Name">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Location:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" value="[Location]" tabindex="1" name="u_userid" placeholder="Location">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Total Cash Collection:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" value="10,000.00" tabindex="1" name="u_userid" placeholder="Total Cash Collection">
				      </div>
				    </div>
				    <div class="form-group">
