							...
							<form class="form-horizontal row page-form" role="form" class="container-fluid">
								...
								<span class="col-md-6">
									...
									<div class="form-group">
								      ...
								      <div class="col-xs-7">
								         <input type="text" class="form-control" id=""  value="[Remarks]" tabindex="2" name="u_username" placeholder="Remarks">
				     				  </div>
								    </div>
								</span>
							</form>
					...
					<div class="panel">
						...
						<div class="panel-body">
							...
							<form class="form-inline">
							  <div class="form-group">
							    <label for="exampleInputName2">Barcode:</label>
							    <input type="text" class="form-control inp-md" id="exampleInputName2" placeholder="">
							  </div>
							  <div class="form-group">
							    <label for="exampleInputEmail2">Description:</label>
							    <input type="email" class="form-control inp-lg" id="exampleInputEmail2" placeholder="">
							  </div>
							  <div class="form-group">
							    <label for="exampleInputEmail2">Qty:</label>
							    <input type="email" class="form-control inp-sm" id="exampleInputEmail2" placeholder="">
							  </div>
							  <div class="form-group">
							    <label for="exampleInputEmail2">Points:</label>
							    <input type="email" class="form-control inp-sm" id="exampleInputEmail2" placeholder="">
							  </div>
							  <button type="submit" class="btn btn-default form-btn main-clr">Add</button>
							</form>
							<hr>
							<form class="form-horizontal row page-form" role="form" class="container-fluid">
								<div class="pull-right">
									<span class="col-md-12">
										<div class="form-group">
										  ...
										  <div class="col-xs-7">
											   <input type="text" class="form-control" id=""  value="" tabindex="2" name="u_username" placeholder="">
										  </div>
										</div>
										<div class="form-group">
