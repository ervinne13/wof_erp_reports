	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-4">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="" id="" tabindex="1" name="u_userid" placeholder="Address">
				      </div>
				    </div>
				</span>
				<span class="col-md-4">
			...
			<div class="btn-cont">
				...
				<a type="button" href="<?= base_url("app/".$this->uri->segment(2)."/".$this->uri->segment(3))."/liquidate"?>" class="btn btn-default form-btn main-clr">
				  Save & Close
				</a>
