			...
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-5">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Qty/No. of Days">
				      </div>
				    </div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="" id="" tabindex="1" name="u_userid" placeholder="Comment">
				      </div>
				    </div>
				</span>
			</form>
