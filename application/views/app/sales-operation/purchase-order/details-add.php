			...
			<form class="form-horizontal row page-form" role="form" class="container">
				...
				<span class="col-md-4">
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Currency">
				      </div>
				    </div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
					  ...
					  <div class="col-xs-7">          
				        <input type="text" class="form-control" id="" name="u_password" placeholder="Catalogue Price" tabindex="3" >
				      </div>
					</div>
					<div class="form-group">
