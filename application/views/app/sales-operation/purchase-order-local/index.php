...
var	table = $('.dynatable').bind('dynatable:init', function(e, dynatable) {
    	$('#dynatable-search-tbl-sales-operation-local').prepend('Date Filter: <input type="search" data-dynatable-query="date-from" name="date-from" id="date-from"/><input type="search" data-dynatable-query="date-to" name="date-to" id="date-to"/> ')
		...
		$('#dynatable-search-tbl-sales-operation-local .clear').on('click',function(){
