			...
			<form id="<?=$this->uri->segment(3)?>-form" class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-6">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="1" name="POL_DocNo" value="<?=$data['POL_DocNo']?>" placeholder="Document No.">
				      </div>
					</div>		
				   <div class="form-group">
				      <label class="control-label col-xs-5" for="">Supplier Name:</label>
				      <div class="col-xs-7">
				      	<select class="form-control single-default"  placeholder="Supplier Name" data-id="<?=$data['POL_SupplierName']?>" name="POL_SupplierName" tabindex="2">
				     ...
				     <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="s_id" tabindex="3"  name="POL_SupplierID" value="<?=$data['POL_SupplierID']?>" placeholder="Supplier ID">
				       </div> 
				    </div>
				    <div class="form-group">
				      <label for="sel1" class="control-label col-xs-5">Supplier Address:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="s_address" tabindex="4" name="POL_SupplierAddress" value="<?=$data['POL_SupplierAddress']?>" placeholder="Supplier Address">
				      </div>
				    </div>
				    <div class="form-group" hidden>
				      <label class="control-label col-xs-5" for="">Payment Terms:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="terms_id" tabindex="5" data-id="" name="POL_Terms" value="<?=$data['POL_Terms']?>" placeholder="Payment Terms">
				      </div>
				    </div>	
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">TIN:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="tin_no" tabindex="6" value="<?=$data['POL_TIN']?>" data-id="" name="POL_TIN" placeholder="TIN">
				      </div>
				    </div>	
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Remarks:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="7" name="POL_Remarks" value="<?=$data['POL_Remarks']?>" placeholder="Remarks">
				      </div>
				    </div>		 
				</span>
				<span class="col-md-6">	
				      ...
				      <div class="col-xs-7">
				        ...
				        <select class="form-control single-default" placeholder="Location" id="lc" name="POL_Location" tabindex="9">
						  	...
						  	<?php foreach ($location as $key => $value) { ?>
						  		<option value="<?=$value['SP_StoreID']?>" <?=($data['POL_Location'] == $value['SP_StoreID'])||($dlocation == $value['SP_StoreID'])?'selected':''?> ><?=$value['SP_StoreName']?></option>
						  	<?php } ?>
						</select>
					  	<?php }else{ ?>
					  		<input type="text" class="form-control" id="" readonly value="<?=$location[0]['SP_StoreID']?>" tabindex="10" name="POL_Location" placeholder="Location">
				        <?php } ?>
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="com_id" readonly value="<?=(!$data['POL_Status']||$data['POL_Status']=='Cancelled')? $dcompany : $data['POL_Company'] ?>" tabindex="12" name="POL_Company" placeholder="Company">
				      </div>
				    </div>		
				   <div class="form-group" hidden>
				      ...
				      <div class="col-xs-7">
				        <select class="form-control single-default" placeholder="Supplier Posting Group" id="" name="POL_SupplierPostingGroup" tabindex="11">
						  	...
						  	?>
						  		<option value="<?=trim($value['SPG_Code'])?>"  <?= $value['SPG_Code']==$data['POL_SupplierPostingGroup']?'selected':''?> ><?=$value['SPG_Code']?></option>
						  	<?php }} ?>
						</select>
				      </div>
				    </div>
				    <div class="form-group" hidden>
				      ...
				      <div class="col-xs-7">
				        <select class="form-control single-default" placeholder="WHT Posting Group" id="" name="POL_WHTPostingGroup" tabindex="12">
						  	...
						  	?>
						  		<option value="<?=trim($value['WBPG_Code'])?>"  <?= $value['WBPG_Code']==$data['POL_WHTPostingGroup']?'selected':''?> ><?=$value['WBPG_Code']?></option>
						  	<?php }} ?>
						</select>
				      </div>
				    </div>
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <select class="form-control single-default" placeholder="VAT Posting Group" id="" name="POL_VATPostingGroup" tabindex="13">
						  	...
						  	?>
						  		<option value="<?=trim($value['VBPG_Code'])?>" <?= $value['VBPG_Code']==$data['POL_VATPostingGroup']?'selected':''?> ><?=$value['VBPG_Code']?></option>
						  	<?php }} ?>
						</select>
				      </div>
				    </div>
				     <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" id="" tabindex="14" name="POL_RefNo"  value="<?=$data['POL_RefNo']?>"  placeholder="Reference No.">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Status:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" readonly id="status" tabindex="15" data-id="" name="POL_Status" value="<?=$data['POL_Status']?>" placeholder="Status">
				      </div>
				    </div>		
				</span>				
			</form>
  ...
  $select = $('.select-cli').each(function(index, obj){
	...
	$.ajax({
        ...
        success: function(res) {
            ...
            supplier.setValue($('select[name=POL_SupplierName]').data('id'),'silent');
