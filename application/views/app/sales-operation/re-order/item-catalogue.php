<div class="panel">
	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
			<div id="rpc-cont" class="col-md-12">
					    	...
					    	<div class="panel-heading">
						  	...
						  	<div class="panel-body">
								...
								<form class="form-horizontal caption">
								    ...
								    <div class="form-group">
									  <label for="sel1" class="control-label col-xs-4">Price.:</label>
									  <div class="col-xs-8">
								         <label for="sel1" class="control-label">1.00</label>
								      </div>
								    </div>
									<div class="form-group">
									  <div class="col-xs-4 pull-right">
								        <button type="submit" class="btn btn-default form-btn main-clr pull-right">Save</button>
	                                  </div>
									</div>
								</form>
							</div>
...
<script type="text/javascript">
	function ulWriter(rowIndex, record, columns, cellWriter) {
	  ...
	  li = '<li class="col-md-3"><div class="panel thumbnail"><div class="panel-heading"><h3 class="panel-title">'+record.item+'</h3></div><div class="panel-body"><span class="rpc-img-cnt thumbnail-image">' + record.thumbnail + '</span><hr><form class="form-horizontal caption"><div class="form-group"><label for="sel1" class="control-label col-xs-4">Qty.:</label><div class="col-xs-8"><input type="text" class="form-control" id="" tabindex="1" name="u_userid" placeholder="Qty."></div></div><div class="form-group"><label for="sel1" class="control-label col-xs-4">Price:</label><div class="col-xs-8"><label for="sel1" class="control-label">1.00:</label></div></div><div class="form-group"><div class="col-xs-4 pull-right"><button type="submit" class="btn btn-default form-btn main-clr pull-right">Save</button></div></div></form></div></li>';
	  return li;
	}
