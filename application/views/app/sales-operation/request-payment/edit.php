			...
			<form class="form-horizontal row page-form" role="form" class="container-fluid">
				<span class="col-md-4">
					<div class="form-group">
					  ...
					  <div class="col-xs-7">
				        <input type="text" class="form-control" value="RP-100001" id="" tabindex="1" name="u_userid" placeholder="Document No.">
				      </div>
					</div>
				    <div class="form-group">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="05/28/15" id="" tabindex="1" name="u_userid" placeholder="Due Date">
				      </div>
				    </div>
				    <div class="form-group">
				...
				<span class="col-md-4">
				    ...
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="V-100008" id="" tabindex="1" name="u_userid" placeholder="Vendor No">
				      </div>
				    </div>
				</span>
				<span class="col-md-4">
				    <div class="form-group">
				      ...
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="Meralco" id="" tabindex="2" name="u_username" placeholder="Vendor Name">
				       </div> 
				    </div>
				    <div class="form-group">
				      <label for="sel1" class="control-label col-xs-5">Supplier Address:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="ALABANG, MUNTINLUPA CITY" id="" tabindex="2" name="u_username" placeholder="Vendor Address">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Supplier Ref. No:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="[Vendor Ref. No.]" id="" tabindex="1" name="u_userid" placeholder="Vendor Ref. No">
				      </div>
				    </div>
				    <div class="form-group">
				      <label class="control-label col-xs-5" for="">Payment Terms:</label>
				      <div class="col-xs-7">
				        <input type="text" class="form-control" value="COD" id="" tabindex="1" name="u_userid" placeholder="Payment Terms">
				      </div>
				    </div>
				</span>
			</form>
