...
<div class="col-md-4 ">
	<div class="form-pane form form-horizontal">
		...
		<fieldset>
			<div class="form-group">
				<div class="col-md-5 control-label">Transaction Type:</div>
				<div class="col-md-7">
			...
			<?php if ($type == 'FGC'): ?>
				...
				<div class="form-group ">
					<div class="col-md-5 control-label">VIP:</div>
					<div class="col-md-7">
						<div class="vip-check">
							<input type="checkbox" onclick="token.vip();" id="is-vip">
						</div>
					</div>
				</div>
			...
			<?php if ($type == 'FGC' || $type == 'VIP'): ?>
				<div class="form-group ">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" name="FTTI_VIPCardNo" value="<?=$details['FTTI_VIPCardNo'];?>" id="vip-card-no" <?=$type == 'FGC' ? 'disabled' : NULL;?>>
					</div>
				</div>
			<?php endif ?>
