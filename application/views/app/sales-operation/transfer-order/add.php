            ...
            <form id="<?= $this->uri->segment(3) ?>-form" class="form-horizontal row page-form container-fluid" role="form">
                <span class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="1" value="" name="TO_DocNo" placeholder="Document No.">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Transfer From:</label>                        
                        <div class="col-xs-7">
                            <select class="form-control select-cli" name="TO_TransferFrom" placeholder="Transfer To">
                                <?php if ($transfer_type == 'incoming'): ?>
                                    <?php if (count($all_locations) > 1): ?>
                                        ...
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <input type="text" class="form-control" readonly value="<?= $all_locations[0]['SP_StoreID'] ?>" name="TO_TransferFrom" placeholder="Transfer From">
                                    <?php endif; ?>
                                <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" tabindex="4" name="TO_Remarks" placeholder="Remarks">
                        </div>
                    </div>
                </span>                
                <span class="col-md-5">                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="7" name="TO_Company" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Status:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="8" name="TO_Status">
                        </div>
                    </div>                   
                </span>
            </form>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        $(document).ready(function () {
            ...
            moduleProcessor.loadNumberSeries('input[name=TO_DocNo]');
