...
//        alert(paginationEnabled);
            ...
            var incomingAjaxURL = base_url + "app/" + moduleHeader + "/transfer-order/data?type=incoming";
            var outgoingAjaxURL = base_url + "app/" + moduleHeader + "/transfer-order/data?type=outgoing";
            var pendingRQAjaxURL = base_url + "app/" + moduleHeader + "/transfer-order/pendingRQ";
            ...
            $locationSelect = $('.location-filter').selectize({
                sortField: 'text',
                onChange: function (value) {
            ...
            $companySelect = $('.company-filter').selectize({
                sortField: 'text',
                onChange: function (value) {
            ...
            $locationSelect[0].selectize.setValue(defaultLocation);
