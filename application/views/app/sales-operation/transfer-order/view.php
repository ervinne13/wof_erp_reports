            ...
            <form class="form-horizontal row page-form" role="form" class="container-fluid">
                <span class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <label class="control-label"><?= $TO_DocNo ?></label> 
                        </div>
                    </div>                    
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Transfer From:</label>
                        <div class="col-xs-7">
                            <label class="control-label"><?= $TO_TransferFrom ?></label> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Transfer To:</label>
                        <div class="col-xs-7">
                            <label class="control-label"><?= $TO_TransferTo ?></label> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="sel1" class="control-label col-xs-5">Remarks:</label>
                        <div class="col-xs-7">
                            <label class="control-label"><?= $TO_Remarks ?></label>
                        </div>
                    </div>
                </span>
                <span class="col-md-6">
