            ...
            <form id="<?= $this->uri->segment(3) ?>-form" class="form-horizontal row page-form container-fluid" role="form">
                <span class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="1" value="<?= $TOL_DocNo ?>" name="TOL_DocNo" placeholder="Document No.">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">                        
                            <?php if ($transfer_type == 'incoming'): ?>
                                <input type="text" class="form-control" readonly value="<?=$TOL_TransferFrom?>" name="TOL_TransferFrom" placeholder="Transfer From">
                             <?php else: ?>  
                                <select class="form-control select-cli" name="TOL_TransferFrom" placeholder="Transfer From">
                                    <?php if (count($user_locations) > 1): ?>
                                        ...
                                        <?php foreach ($user_locations AS $location): ?>
                                            <?php $selected = $location["SP_StoreID"] == $TOL_TransferFrom ? "selected" : "" ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <?php if ($transfer_type == 'incoming'): ?>
                                <input type="text" class="form-control" readonly value="<?=$TOL_TransferTo?>" name="TOL_TransferTo" placeholder="Transfer To">                                    
                            <?php else: ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" <?= $readOnly?> tabindex="4" value="<?= $TOL_Remarks ?>" name="TOL_Remarks" placeholder="Remarks">
                        </div>
                    </div>
                </span>                
                <span class="col-md-5">                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="7" name="TOL_Company" value="<?= $TOL_Company ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="">Status:</label>
                        <div class="col-xs-7">
                            <input type="text" class="form-control" readonly tabindex="8" name="TOL_Status" value="<?= $TOL_Status ?>">
                        </div>
                    </div>                   
                </span>
            </form>
    ...
    (function () {
        ...
        function initializeUI() {
            ...
            if(transferType == "outgoing"){
                ...
                transTo.load(function(callback) {
                        for(var x in locStrucJSON){
                            if(locStrucJSON[x]['LOC_Id'] == '<?=$TOL_TransferTo?>'){
                                subLocInit.push(locStrucJSON[x]);
                            }
                        }
                        console.log('<?=$TOL_TransferTo?>');
                        callback(subLocInit);
                    });
                
                transTo.setValue('<?=$TOL_TransferTo?>');
            }
        }
