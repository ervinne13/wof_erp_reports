...
<div style="padding: 4px;">
    ...
    <div style="display: none">
        <div id="week-1-total-pisoCoin"><?= $weekly_totals['QtyRetrievedWeek1'] ?></div>
        <div id="week-2-total-pisoCoin"><?= $weekly_totals['QtyRetrievedWeek2'] ?></div>
        <div id="week-3-total-pisoCoin"><?= $weekly_totals['QtyRetrievedWeek3'] ?></div>
        <div id="week-4-total-pisoCoin"><?= $weekly_totals['QtyRetrievedWeek4'] ?></div>        

        <div id="RV_MonthlyRunningTotal-pisoCoin"><?= $RV_MonthlyRunningTotal ?></div>
        <div id="RV_RetrievalDateRunningTotal-pisoCoin"><?= $RV_RetrievalDateRunningTotal ?></div>
