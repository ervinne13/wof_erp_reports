...
<div style="padding: 4px;">
    ...
    <div style="display: none">
        <div id="week-1-total-token"><?= $weekly_totals['QtyRetrievedWeek1'] ?></div>
        <div id="week-2-total-token"><?= $weekly_totals['QtyRetrievedWeek2'] ?></div>
        <div id="week-3-total-token"><?= $weekly_totals['QtyRetrievedWeek3'] ?></div>
        <div id="week-4-total-token"><?= $weekly_totals['QtyRetrievedWeek4'] ?></div>

        <div id="RV_MonthlyRunningTotal-token"><?= $RV_MonthlyRunningTotal ?></div>
        <div id="RV_RetrievalDateRunningTotal-token"><?= $RV_RetrievalDateRunningTotal ?></div>
