<div class="panel">
	...
	<div class="panel-body">
		<div id="data-container" class="container-fluid">
          ...
          <span class="col-md-4">
            <div class="form-group">
              <label class="control-label col-xs-5" for="">Employee Status:</label>
              <div class="col-xs-7">
                <input type="text" class="form-control" id="" tabindex="2" name="u_username" placeholder="Employee Status">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-xs-5" for="">End of Contract Date:</label>
              <div class="col-xs-7">
                <input type="text" class="form-control" id="" tabindex="2" name="u_username" placeholder="End of Contract Date">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-xs-5" for="">Extended until:</label>
              <div class="col-xs-7">
                <input type="text" class="form-control" id="" tabindex="2" name="u_username" placeholder="Extended until">
              </div>
            </div>
            <div class="form-group">
